...
<%strip%>
    <%include file="../common/pmnav.tpl" menu="doctorlist"%>
    <div class="content">
        <form method="post" action="">
            <select></select><input type="text"><input type="submit" value="查询"><input type="submit" value="返回全部">
        </form>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <th>姓名</th><th>医院</th><th>科室</th><th>手机</th><th>操作</th>
            </tr>
            <tr>
                <td>录入员</td><td>录入员</td><td>录入员</td><td>录入员</td><td><a href="#">编辑</a><a href="#">删除</a></td>
            </tr>
            <tr>
                <td>录入员</td><td>录入员</td><td>录入员</td><td>录入员</td><td><a href="#">编辑</a><a href="#">删除</a></td>
            </tr>
